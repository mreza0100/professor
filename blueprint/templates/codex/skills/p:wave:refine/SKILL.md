---
name: p:wave:refine
description: Wave task refinement — critically evaluates a task list through R1-R4 protocol, produces wave.md.
---

Read `.claude/skills/p:wave:refine/SKILL.md` in full — it is the source-of-truth protocol. Follow it verbatim.
