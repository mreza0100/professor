...
Read `.claude/skills/p:360/SKILL.md` in full — it is the source-of-truth protocol. Follow it verbatim.

## Codex-only execution mapping

- Embedded 360 runs must use a separate clean-context Codex agent.
- Spawn the 360 agent with only the subject, domain (`test` or `inquiry`), and the instruction to read `.claude/skills/p:360/SKILL.md`.
