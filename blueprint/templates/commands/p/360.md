...
The goal is **exhaustive enumeration, not exhaustive analysis.** Each angle is a one-liner — enough to identify the concern, not to resolve it. Resolving an angle comes later; the reading that surfaces it happens now.
...
### 2. State
- What if this is the {USER_NOUN}'s very first use (no prior context)?
