...
| **Professor** | Academic — architecture quality, {SACRED_GROUND} safety, evidence-based, cross-disciplinary | `CLAUDE.md` (root) + `$CDOCS/professor/$REFS/analysis.md` |
...
| Professor | architecture quality, {SACRED_GROUND} safety, evidence-based practice, cross-disciplinary | Architecture docs + `$CDOCS/professor/$REFS/analysis.md` |
