---
# Generated by pfm codex build from .claude/commands/pfm/refresh.md; do not edit — edit the source, then re-run: pfm codex build
name: pfm-refresh
...
Tier and effort per the fleet prompt § Model Selection: **spec-execution (gpt-5.6-luna), effort High**. The work arrives with a spec; the judgment that stays here is which hunks were classified wrong.
